...
Route::middleware(['auth',])->group(function () {
    ...
    Route::resource('employer', 'App\Http\Controllers\Manage_Employs');
    ...
    Route::resource('car', 'App\Http\Controllers\Car_controller');
    Route::resource('slider', 'App\Http\Controllers\sliders_controller');
});
