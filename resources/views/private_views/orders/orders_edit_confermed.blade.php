    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container m-auto mt-2">
                <form style="margin-top: 2rem;" action="{{ route('update2', $order->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                    ...
                    <div class="form-row ">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text"  class="form-control" id="inputAddress" value="{{ $order->Price }}"
                                name="Price">
                        </div>
                        ...
                        <div class="form-check form-check-inline text-center">
                            <input class="form-check-input" type="checkbox" name="Car_out" id="inlineRadio1">
                            <label class="form-check-label" for="inlineRadio1"> Car is out </label>
                        </div>

                        <div class="form-check form-check-inline text-center">
                            <input class="form-check-input" type="checkbox" name="Canceled" id="inlineRadio2">
                            <label class="form-check-label" for="inlineRadio2"> Canceled</label>
                        </div>
                    </div>
                        {{-- 
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="Is_paid" id="inlineRadio3">
